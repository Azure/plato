...
class MoabModel:
    ...
    # returns a noise value in the range [-scalar .. scalar] with a gaussian
    # distribution
    @staticmethod
    ...
    def update_plate(self, plate_reset: bool = False):
        ...
        # convert z[-1..1] to [PLATE_HEIGHT_MAX/2 - self.plate_z_limit ..
        # PLATE_HEIGHT_MAX/2 + self.plate_z_limit]
    ...
    def _update_estimated_ball(self, ball: Vector3):
        ...
        # update ball position in plate origin coordinates, and obstacle distance and
        # direction
    ...
    def _get_obstacle_distance(self) -> float:
        # Ignore z value, calculate distance between obstacle and ball projection on
        # plate
    ...
    def _ball_plate_contact(self, step_t: float) -> float:
        ...
        if rot_distance > 0:
            ...
            # Create a quaternion that represents the delta rotation for this time
            # period.
